...
import (
	...
	"github.com/sait/tusd/gcsstore"
)

// go:generate mockgen -destination=./gcsstore_mock_test.go -package=gcsstore_test github.com/sait/tusd/gcsstore GCSReader,GCSAPI
